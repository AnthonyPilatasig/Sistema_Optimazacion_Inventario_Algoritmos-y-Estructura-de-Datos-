...
1. **Clonar o descargar el proyecto**
   ```bash
   git clone [https://github.com/usuario/sistema-optimizacion-inventario.git](https://github.com/AnthonyPilatasig/Sistema_Optimazacion_Inventario_Algoritmos-y-Estructura-de-Datos-.git)
   ```
